            ...
            <Column>
              <div>
                <h1>
                  ...
                  my name is <br/>
                  Lucas Inocente</h1>
                <h2>And I'm a Tech Lead, Software Engineer, Writer, Community Manager, Mentor, Host and Podcast Producer.</h2>
              </div>
            </Column>
          </Columns>
        </div>
        <div className="section">
          ...
          <ul>
            <Card
              ...
              label="Producer, Host and Community Manager"
          ...
          <ul>
            <Card
              ...
              label="Tech Lead, Software Engineer"
